...
class Dropdown extends StatefulWidget {
    ...
    bool isDisabled;
    Dropdown(this.selectGenre,this.theList,this.def,this.dropDownType,this.isDisabled);
...
class _DropdownState extends State<Dropdown> {
  ...
  Widget build(BuildContext context) {
    return DropdownButton<String>(
        ...
        items: (widget.isDisabled) ? null : widget.theList.map<DropdownMenuItem<String>>((String value) {return DropdownMenuItem<String>(value: value, child: Text(value, style: TextStyle(fontSize: 13) ),);}).toList());
  }
}
