...
Future<List<dynamic>> getData() async {
    Response response = await get("https://api.jikan.moe/v3/anime/" + widget.animeID.toString());
...
void initState(){
  ...
  returnData.then((value) => returnList = value);
  super.initState();
}
    ...
    future: getData(),
      builder: (context,snapshot)
      {
        switch(snapshot.connectionState)
        {
          ...
          case ConnectionState.done: return       Scrollbar(
            child: ListView(
              children: [
                Row(
